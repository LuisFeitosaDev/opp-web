    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background to-secondary p-4">
      <Card className="w-full max-w-sm">
        <CardHeader className="items-center text-center">
          <Glasses className="mb-2 h-10 w-10 text-primary" />
          <CardTitle className="text-2xl">OPP Design</CardTitle>
          <CardDescription>Desenvolvimento de Produto — Chilli Beans</CardDescription>
        </CardHeader>
        <CardContent>
